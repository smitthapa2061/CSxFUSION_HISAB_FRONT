...
export default function TeamSelector() {
  ...
  const fetchTeams = async () => {
    try {
      const res = await axios.get(
        "https://csxfusion-hisab-backend.onrender.com/api/bookingData"
      );
      setTeams(res.data);
    } catch {
  ...
  const handleUpdateBooking = async (
    ...
    try {
      await axios.put(
        `https://csxfusion-hisab-backend.onrender.com/api/bookingData/${teamName}/bookings/${bookingIndex}`,
        updatedBooking
      );
  ...
  const handleDeleteTeam = async (teamName) => {
    ...
    try {
      await axios.delete(
        `https://csxfusion-hisab-backend.onrender.com/api/bookingData/${teamName}`
      );
    ...
    try {
      await Promise.all(
        selectedTeams.map((teamName) =>
          axios.post(
            `https://csxfusion-hisab-backend.onrender.com/api/bookingData/${teamName}/bookings`,
            booking
          )
        )
      );
